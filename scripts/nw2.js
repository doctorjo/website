...
class World {
	...
	this.next_strategy =  zero_arr(width*height);
	this.generate(init) // generates starting position
	this.payment =  zero_arr(width*height);
	...
	this.strategy = zero_arr(this.width*this.height);
	this.next_strategy = zero_arr(this.width*this.height);
